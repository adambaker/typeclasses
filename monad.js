...
export var Monad = function(type, defs) {
...
export var mjoin = function(mmv) {
  return mmv.mjoin();
};

export var mbind = function(mv, f) {
  f.mresult = mv.mresult;
  return mv.mbind(f, mv);
}.autoCurry();

export var ap = function(mf, m) {
...
export var State = Constructor(function(runState){
